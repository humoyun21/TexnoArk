...
export default function ProductDrawer({ id }: { id: number }) {
        ...
        >
            ...
            <div className="px-3 pt-4">
                ...
                {({ setFieldValue }) => (
                    ...
                    <h2 className="text-center text-[#3cb043] text-[22px] pb-4 font-semibold">Create new product detail</h2>
                    ...
                    <Button
                        sx={{ fontSize: "16px", fontWeight: "600", padding: "14px", backgroundColor: "#3cb043", "&:hover": { background: "#028a0f" } }}
                        variant="contained"
                        type="submit"
                        className="w-[100%]"
                    >
    ...
    return (
        ...
        <button
            ...
            className="py-2 px-5 rounded-md bg-green-400 text-white font-medium hover:bg-green-600 duration-300 active:bg-green-400"
        >
            Create
        </button>
